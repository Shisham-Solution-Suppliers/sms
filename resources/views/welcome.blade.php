...
<body class="antialiased">
    <div
        class="relative flex items-top justify-center min-h-screen bg-white dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        @if (Route::has('login'))
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0 mt-10">
                <h2><u><a href="{{ route('login')}}">Login</a></u></h2>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://www.facebook.com/Motherland-Computers-177683379280796/?_rdr"
                                    class="underline text-gray-900 dark:text-white">Facebook</a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Motherland Computers is serving people since 2001 in computer software and hardware. It is government registered company.
                            </div>
                        </div>
                    </div>
